...
def verify_multi_round_switch():
    ...
    for i in range(cases):
        ...
        c1_l1, c1_l2 = katan.enc32_bit(x1_l1, x1_l2, key, 6)
        c2_l1, c2_l2 = katan.enc32_bit(x2_l1, x2_l2, key, 6)
        ...
        x3_l1, x3_l2 = katan.dec32_bit(c3_l1, c3_l2, key, 6)
        x4_l1, x4_l2 = katan.dec32_bit(c4_l1, c4_l2, key, 6)
